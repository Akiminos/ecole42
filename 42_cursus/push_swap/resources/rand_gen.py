...
if (str(sys.argv[1]) == "-h" or str(sys.argv[1]) == "--help"):
	print("Usage : generator.sh MIN_VALUE MAX_VALUE(excluded) NBR_OF_VALUES")
	sys.exit(0)
...
f.write("./push_swap $ARG | ./resources/checker_linux $ARG\n")
#f.write("valgrind ./push_swap $ARG | wc -l\n")
#f.write("valgrind ./push_swap $ARG | ./resources/checker_linux $ARG\n")
f.close()
